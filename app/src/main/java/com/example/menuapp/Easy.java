...
public class Easy extends AppCompatActivity {
            ...
            public void run() {
                ...
                if (currentTime > 0) {
                    ...
                    if (buttonState == arrowState) {
                        ...
                        Intent intent = new Intent(Easy.this, FlagQuiz.class);
                ...
                if (currentPoints==10){
                    finish();
                    Toast.makeText(Easy.this, "YOU WIN!!!", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(Easy.this, FlagQuiz.class);
                    startActivity(intent);
    ...
    private void setArrowImage(int state) {
        switch (state) {
            ...
            case STATE_PINK:
                iv_arrow.setImageResource(R.drawable.pink);
    ...
    //set button colors position 1-6
    ...
    private void setButtonImage(int state) {
        switch (state) {
            ...
            case STATE_PINK:
                setRotation(iv_button, R.drawable.button_pink);
